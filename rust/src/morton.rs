...
fn expand_bits(mut x: u32) -> u32 {
    x = (x | (x << 16)) & 0b11111111_00000000_00000000_11111111;
    x = (x | (x << 8)) & 0b00001111_00000000_11110000_00001111;
    x = (x | (x << 4)) & 0b00110011_00001100_00110000_11000011;
    x = (x | (x << 2)) & 0b00001001_00100100_10010010_01001001;
    x
}
