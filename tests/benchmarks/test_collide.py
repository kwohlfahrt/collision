...
@pytest.mark.parametrize(
    "npoints,rmax,ngroups,group_size,rounds",
    [
...
def test_collide(
    cl_env, collision_programs, npoints, rmax, ngroups, group_size, rounds, benchmark
):
    ctx, cq = cl_env
    ...
    n_collisions_buf = cl.Buffer(
        ctx,
        cl.mem_flags.HOST_READ_ONLY | cl.mem_flags.READ_WRITE,
    ...
    benchmark.pedantic(
        collide,
        (cq, collider, coords_buf, radii_buf, n_collisions_buf, None, 0),
        rounds=rounds,
        warmup_rounds=10,
    )
